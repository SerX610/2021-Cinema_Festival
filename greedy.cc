...
restriction on their restriction vectors and increase the count of restrictions
of that film. */
...
/* Function that generates a plan of d days without restrictions using
a greedy algorithm and writes it. */
...
int main(int argc, char **argv) {
  ...
  // Sort the film_info by number of restrictions in descending order;
